...
const PhenotypeReportHabbit = ({details}) => {
...
//    console.log(sign_and_symptomps, 'sign and symptomps')
    return (
        <div>
        <div className="PhenotypeReport phenotype_habbit d-flex flex-column justify-content-between">
            <div>
...
export default PhenotypeReportHabbit;