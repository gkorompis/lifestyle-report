...
//    console.log(sign_and_symptomps, 'sign and symptomps')
  ...
  error ? "error" : first_name;
    return (
       <>
       <div className="PhenotypeReportFitness  d-flex flex-column justify-content-between">
        <div className="d-flex flex-row ">
            <div className="title-bar-fitness d-flex flex-column "style={{backgroundColor: colorRisk(RISK_CATEGORY)}}>
